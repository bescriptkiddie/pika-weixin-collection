...
echo "爬取公众号最新文章ing"
cd "D:\learning\python\pika-weixin-collection"
...
echo "上传md文件中ing"
SOURCE_PATH1="D:\learning\python\pika-weixin-collection\data\微信公众号聚合平台_按时间区分.md"
SOURCE_PATH2="D:\learning\python\pika-weixin-collection\data\微信公众号聚合平台_按公众号区分.md"
